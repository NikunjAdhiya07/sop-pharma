...
export default function MCQReviewPage() {
  ...
  const handleMarkDone = async (reviewId: string) => {
    try {
      const response = await fetch('/api/mcq-review', {
        method: 'PUT',
        headers: { 'Content-Type': 'application/json' },
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-400">Review and edit flagged questions</p>
            </div>
                  ...
                  {!isEditing && (
                    <div className="flex gap-2">
                      ...
                      {review.reviewStatus === 'pending' ? (
                        <button
                          onClick={() => handleMarkDone(review._id)}
