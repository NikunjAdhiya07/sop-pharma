...
// GET /api/training-matrix/sops-for-matrix?department=QA&search=QAGE&excludeAssigned=1
// Returns SOPs from the master DB for use in the "assign SOP to matrix" dropdown.
// SOP master data is READ-ONLY from this endpoint — no mutations allowed here.
