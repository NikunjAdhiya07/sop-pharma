...
// One entry per (employee, sopCode, month, year, department)
MatrixEntryDataSchema.index(
  { employeeName: 1, sopCode: 1, month: 1, year: 1, department: 1 },
  { unique: true, partialFilterExpression: { deletedAt: { $exists: false } } },
);

export default mongoose.models.MatrixEntryData ||
  mongoose.model<IMatrixEntryData>('MatrixEntryData', MatrixEntryDataSchema);
